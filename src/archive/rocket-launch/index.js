...
export default function Home() {
    ...
    const handleCountdownComplete = () => {
        ...
        // Set scene to zoomed-in state (we're "inside the smoke")
        if (sceneWrapperRef.current && !isZoomedIn.current) {
        ...
        // Zoom out from smoke while rocket launches
        ...
        // Synchronize scroll and rocket movement (starts slightly after zoom begins)
        tl.to(window, {
            scrollTo: { y: 0 },
            duration: 5,
            ease: 'power2.inOut',
    ...
    return (
        <main className="relative w-screen overflow-hidden"
            ...
            <div
                ...
                style={{ zIndex: 20, transformOrigin: 'center bottom' }}
            >
                <canvas className="rocket-smoke fixed top-0 left-0 pointer-events-none" style={{ zIndex: 15 }} />
                <div ref={rocketRef} style={{ zIndex: 25 }}>
                    <RocketScene />
                </div>
            </div>
